...
% Code for varying parameters in a single simulation
...
if simulate ==1
    stochastic = 1;
    Wendling8_Sim_v3; % Simulate states and output of the extended neural mass model
    save Wendling_out_vp output8 z normalised_gaussian_input sampling_frequency stochastic MVI tcon C frequency_limits % Save relevant parameters for future use
...
Variable_parameter_uncertainty_exc = 1e-2;  % Uncertianty due parameter varying in time

Variable_parameter_uncertainty_inh =2.5e-2;
