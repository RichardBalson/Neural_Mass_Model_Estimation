...
simulate =0; % Decide whether to simulate model output or use previous results if simulate is equal to  then the model is resimulated
if simulate ==1
    stochastic = 1;
    Wendling8_Sim_v1; % Simulate states and output of the extended neural mass model
    save Wendling_out_cp_boon output8 z normalised_gaussian_input sampling_frequency stochastic MVI tcon C frequency_limits % Save relevant parameters for future use
    ...
    load Wendling_out_cp_boon output8 z normalised_gaussian_input sampling_frequency stochastic MVI tcon C frequency_limits% Load model parameters from previous simulations
end
...
Static_variable_assignment_boon;
