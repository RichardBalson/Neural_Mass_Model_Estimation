...
% Code for varying number of parameters estimated
...
% Dp = 0; % Number of parameters to be estimated
Dk =0; %Number of stochastic inputs in the system that need to be estimated
