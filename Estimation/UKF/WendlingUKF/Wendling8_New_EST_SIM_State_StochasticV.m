...
% Code for determining the effect of the variance of the input on state
% estimates
...
Generate_figures;
    ...
    simulation_namez = strcat(simulation_name,'_z_', int2str(zoom),'s_'); 
